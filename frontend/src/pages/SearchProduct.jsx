        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <select
              ...
              className="bg-white border border-gray-300 rounded-lg px-4 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-600 cursor-pointer"
            >
            ...
            <button
              ...
              className="bg-white p-2 rounded-lg shadow-sm text-gray-600 hover:text-blue-600 sm:hidden transition-colors duration-200"
            >
              ...
              {products.map((product) => (
                ...
                >
                  <div
                    className={
                      viewMode === 'grid'
                        ? 'space-y-4 bg-white rounded shadow-md'
                        : 'flex-shrink-0 w-48 bg-white rounded shadow-md'
                    }
                  >
                    <img
                      src={
                      ...
                      className={`w-full rounded-lg object-contain p-2 mix-blend-multiply ${
                        viewMode === 'grid' ? 'h-50' : 'h-32 mt-10'
                      }`}
                      onError={(e) =>
